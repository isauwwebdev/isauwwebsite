...
function Apply() {
  ...
  const submitForm = (e) => {
    ...
    reader.onload = function (e) {
      ...
      fetch(
        "https://script.google.com/a/macros/uw.edu/s/AKfycby1bv3HsU4lBqypa4JHfsxeLQoY2Pw4-t6jEZigCkgzAk4PDg-stSU67TXvNawRt5BF/exec",
        {
          method: "POST",
        ...
        .then((a) => {
          ...
          fetch(
            "https://script.google.com/a/macros/uw.edu/s/AKfycbw5JXVwWuFCYyAbJ0QTzGwsvcltjAdSM4pzhc5aYEEEvYqbgZ3ALm8t8rhKn45mDfFcrQ/exec",
      ...
      <Container>
        <Row className="justify-content-center">
          <Col xs={12} sm={10} md={8} lg={6} className="my-5">
            <div>
              <h1>
                <strong>'23-'24 ISAUW Officer Application</strong>
              </h1>
              ...
              <section className="my-3">
                ...
                {showPortfolio && (
                  <span style={{ color: "rgba(129, 27, 20, 1.0)" }}>
                    You have indicated that you are applying to at least one of
                    the following positions: Creativity Management,
                    Documentation or Design. Please be sure to bring your
                    portfolio should you be contacted for an interview.
                  </span>
                )}
              </section>
        ...
        >
          ...
          <Modal.Body>
            Thank you for applying. We will get back to you regarding the status
            of your application.
            <br />
