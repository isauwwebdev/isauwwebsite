                ...
                <Row className="mb-3">
                    ...
                    <Col xs={6} md={4} lg={3} style={{ height: "100%", marginBottom: "10px" }}>
                        <div className="form-group" style={{ height: "100%" }}>
                            ...
                            <select id="prodSelect" name="product" className="form-select" value={prodSelect} onChange={handleChange}>
                                {prodChoices}
                            </select>
                        </div>
                    </Col>
                    <Col xs={6} md={4} lg={3} style={{ height: "100%", marginBottom: "10px" }}>
                        <div className="form-group" style={{ height: "100%" }}>
                            ...
                            <select id="pickUpSelect" name="pickUpPoint" className="form-select" value={pickUpSelect} onChange={handleChange}>
                                {pickUpChoices}
                            </select>
                        </div>
                    </Col>
